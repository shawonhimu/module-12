                        ...
                        <div class="col-md-6">
                            <div class="loginCard">
                                ...
                                <div class="loginLogo">
                                    ...
                                    <h5 class="text-dark text-uppercase mb-3">Login as Admin</h5>
                                </div>
                                {{-- Login Form --}}
                                <div id="adminForm">
                                    <form action="{{ url('/admin') }}" class="loginForm" id="" method="POST">
                                        @csrf
                                        <input type="text" name="username" class="form-control text-center"
                                            id="" placeholder="Enter your username" required>
