            ...
            <div class="adminContents">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <form action="/supervisor" method="POST" class="mb-4">
                                @csrf
                                <div class="mt-3 newCard p-4">
                                    <h5>Add new supervisor</h5>
                                    <hr>
                                    <div class="mb-3">
                                        <label for="nameID" class="form-label">Supervisor Name </label>
                                        <input type="text" name="name" class="form-control" id="nameID"
                                            placeholder="Enter name" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="phoneID" class="form-label">Supervisor Phone </label>
